...
frisby.create("create a new stream")
    .post(base_url + "streams",{"name": "StreamTest", "description":"Description","url":"rtmp://mystream.de/1234","state":1})
    .expectStatus(201)
	.expectJSON({
		  name: "StreamTest",
    ...
    console.log(json);
		...
		frisby.create("update streams on position " + json._id)
			.put(base_url + "streams/" + json._id,{"name": "StreamTestChanged", "url":"rtmp://mystream.de/12345", "description":"none","state":2})
			.expectStatus(200)
			.expectJSON({
		...
		frisby.create("update streams on position " + json._id + " only name")
			.put(base_url + "streams/" + json._id,{"name": "StreamTestNameChanged"})
			.expectStatus(200)
			.expectJSON({
		...
		frisby.create("update streams on position " + json._id + " only url")
			.put(base_url + "streams/" + json._id,{"url":"rtmp://mystream.de/123456"})
			.expectStatus(200)
			.expectJSON({
				  name: "StreamTestNameChanged",
		...
		frisby.create("update streams on position " + json._id + " only description")
			.put(base_url + "streams/" + json._id,{"description":"back"})
			.expectStatus(200)
			.expectJSON({
				  name: "StreamTestNameChanged",
				  url:"rtmp://mystream.de/123456",
		...
		frisby.create("update streams on position " + json._id + " only state")
			.put(base_url + "streams/" + json._id,{"state":0})
			.expectStatus(200)
			.expectJSON({
				  name: "StreamTestNameChanged",
				  url:"rtmp://mystream.de/123456",
		...
		frisby.create("update streams on position " + json._id + " bad data")
			.put(base_url + "streams/" + json._id,{"kame": "peter", "kurl":"15"})
			.expectStatus(200)
			.expectJSON({
				  name: "StreamTestNameChanged",
				  url:"rtmp://mystream.de/123456",
...
frisby.create("create a new stream without description")
    .post(base_url + "streams",{"name": "StreamTest","url":"rtmp://mystream.de/1234","state":1})
    .expectStatus(201)
	.expectJSON({
		  name: "StreamTest",
		  url:"rtmp://mystream.de/1234",
...
frisby.create("create a new stream without state")
    .post(base_url + "streams",{"name": "StreamTest", "description":"Description","url":"rtmp://mystream.de/1234"})
    .expectStatus(201)
	.expectJSON({
		  name: "StreamTest",
		  url:"rtmp://mystream.de/1234",
...
frisby.create("create a new stream without name")
    .post(base_url + "streams",{"description":"Description","url":"rtmp://mystream.de/1234","state":1})
    .expectStatus(400)
    .expectHeaderContains("content-type", "application/json")
	.toss();
  	
frisby.create("create a new stream without url")
    .post(base_url + "streams",{"name":"test","description":"Description","state":1})
    .expectStatus(400)
    .expectHeaderContains("content-type", "application/json")
	.toss();
